...
local ThemeManager = {} do
	...
	['Default']        = { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"191919","AccentColor":"00d8ff","BackgroundColor":"0f0f0f","OutlineColor":"282828"}') },
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddButton('Create theme', function() 
			...
			self.Library.Options.ThemeManager_CustomThemeList:SetValue(nil)
								...
								self.Library:Notify(string.format('Created theme %q', self.Library.Options.ThemeManager_CustomThemeName.Value))
		end)
